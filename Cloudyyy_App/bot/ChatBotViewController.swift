    ...
    func choiceMessageCell(_ cell: ChoiceMessageCell, didSelectChoice title: String) {
        ...
        if title.lowercased().contains("yes") {
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.25) {
                let tasks: [Task] = [
                    Task(title: "Water Your Plants", time: "8:30 pm", sizeFactor: 1.6, color: UIColor.systemOrange),
                    Task(title: "Do Dishes", time: "10:30 pm", sizeFactor: 1.0, color: UIColor.systemGreen),
                    Task(title: "Play", time: "6:30 pm", sizeFactor: 0.9, color: UIColor.systemPink)
                ]
