...
final class DreamItViewController: UIViewController {
    ...
    // Mock Balance (Only used for calculating progress bars now)
    ...
    private func setupContentLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            activeScroll.heightAnchor.constraint(equalToConstant: 240), // Taller for big dream cards
    ...
    private func reloadForKid(_ kid: Kid) {
        ...
        if !activeItems.isEmpty {
            activeItems.append(RewardDetailItem(id: "99", title: "New Bicycle", subtitle: "Sports", points: 5000, imageName: "Cycle", isActive: true))
            activeItems.append(RewardDetailItem(id: "98", title: "Game Console", subtitle: "Tech", points: 8000, imageName: "Cycle", isActive: true))
        }
...
final class DreamCard: UIView {
    ...
    init(item: RewardDetailItem, currentBalance: Int) {
        ...
        // 1. SUBTLE BACKGROUND (Matches Schedule/Approval Cards)
        backgroundColor = UIColor(red: 40/255, green: 45/255, blue: 65/255, alpha: 1)
        layer.cornerRadius = 24
        clipsToBounds = true
        
        // 2. Big Icon (Very Faded - Subtle Background Detail)
        iconView.text = "🚲"
        ...
        iconView.alpha = 0.05 // <--- Extremely subtle
        ...
        progressView.progressTintColor = UIColor(red: 64/255, green: 156/255, blue: 255/255, alpha: 1) // Task Blue
