...
// ------------------------------
// MARK: - Schedule Page Models (Defined in original file)
// ------------------------------
...
struct RewardDetailItem {
    ...
    let subtitle: String
    let points: Int
    let imageName: String?    // local asset for now, later URL
    let isActive: Bool        // true = Active section, false = Completed
}
...
final class ChildManager {
    ...
    func schedule(for kidId: String) -> [ScheduleTask] {
        ...
        let todayString = dateString(day: cal.component(.day, from: now))

        switch kidId {
        case "kid_bob":
            return [
                ScheduleTask(title: "Do the Homework", time: "06:00 AM", category: "Habits", status: "Not Done", date: dateString(day: 8)),
                ScheduleTask(title: "Math Practice", time: "07:30 AM", category: "Study", status: "In progress", date: todayString),
                ScheduleTask(title: "Brush Teeth", time: "09:00 AM", category: "Habits", status: "Completed", date: todayString),
        ...
        case "kid_jonesh":
            return [
                ScheduleTask(title: "Brush Teeth", time: "07:00 AM", category: "Habits", status: "Completed", date: todayString),
        ...
        default:
            return [
                ScheduleTask(title: "Read a Book", time: "06:30 PM", category: "Habits", status: "Not Done", date: todayString)
            ]
        }
    }
